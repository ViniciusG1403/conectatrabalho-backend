...
COMMENT ON COLUMN contractor_profile.nr_telefone IS E'Número de telefone';
...
COMMENT ON COLUMN contractor_profile.img_profile_url IS E'URL da imagem de perfil';
...
COMMENT ON COLUMN worker_profile.nr_telefone IS E'Número de telefone';
...
COMMENT ON COLUMN worker_profile.img_profile_url IS E'URL da imagem de perfil';