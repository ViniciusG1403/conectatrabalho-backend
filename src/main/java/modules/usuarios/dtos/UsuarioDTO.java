...
public class UsuarioDTO {
    ...
    @Schema(name = "status", required = true, title = "Status do usuário", example = "0 - INATIVO, 1 - ATIVO, 2 - BLOQUEADO, 3 - EXCLUIDO")
    private Integer status;

    @Schema(name = "registro", required = true, title = "Data de registro do usuário", example = "2024-02-13 00:00:00")
    private Timestamp registro;

    @Schema(name = "ultimaAtualizacao", required = true, title = "Última atualização do usuário", example = "2024-02-13 00:00:00")
    private Timestamp ultimaAtualizacao;

    @Size(min = 6, max = 6, message = "O código deve ter 6 caracteres")
    @Schema(name = "codigo", title = "Código de verificação do usuário", example = "123456")
